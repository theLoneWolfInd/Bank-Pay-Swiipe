...
class SendMoneyPersonal: UIViewController,MFMessageComposeViewControllerDelegate,UITableViewDelegate,UITableViewDataSource, CNContactViewControllerDelegate {
    ...
    @objc func segmentControlClickMethod() {
        if segmentControls.selectedSegmentIndex == 0 {
            ...
            self.usersListWBForSendOrReceive(strSendOrReceive: "SEND", strForCell: "8")
    ...
    @objc func usersListWBForSendOrReceive(strSendOrReceive:String,strForCell:String) {
                               ...
                               case .success(_):
                                  if let data = response.result.value {
                                   ...
                                   if strSuccess == "success" //true
                                   {
                                    ...
                                    if self.arrListOfSendReceiveUsers.count > 0 {
        ...
        func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
            if  searchArrayStr == "1" {
                ...
                return self.arrListOfSendReceiveUsers.count
        ...
        func tableView(_ tableView: UITableView, heightForRowAt indexPath: IndexPath) -> CGFloat {
          ...
          func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
            ...
            if searchArrayStr == "1" {
                ...
                // send
                let contact = self.arrListOfSendReceiveUsers[indexPath.row]
            ...
            if userName == "loginViaPersonal" {
                if self.strCheckSearchArray == "1" {
                    ...
                    if segmentControls.selectedSegmentIndex == 1 {
                        let contact2 = self.arrListOfSendReceiveUsers[indexPath.row]
                        /*
                         amount = "2.55";
