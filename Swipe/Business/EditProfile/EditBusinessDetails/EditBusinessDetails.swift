//
//  EditBusinessDetails.swift
//  Swipe
//
//  Created by evs_SSD on 1/29/20.
...
class EditBusinessDetails: UIViewController,UITextFieldDelegate,UIImagePickerControllerDelegate,UINavigationControllerDelegate {
    ...
    @IBOutlet weak var navigationBar:UIView! {
       ...
       @IBOutlet weak var lblNavigationTitle:UILabel! {
           didSet {
               lblNavigationTitle.text = "Edit Business Details"
