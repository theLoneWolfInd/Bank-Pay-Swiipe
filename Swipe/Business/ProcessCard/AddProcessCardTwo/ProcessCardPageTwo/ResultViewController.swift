...
class ResultViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        // print(self.expirationLabel.text as Any)
        
        UserDefaults.standard.set(expirationLabel.text, forKey: "keySaveExpDate")
    }
    ...
    func format15(number: String) -> String {
        ...
        for (idx, char) in number.enumerated() {
            ...
            UserDefaults.standard.set(displayNumber, forKey: "KeySaveCardNumber")
